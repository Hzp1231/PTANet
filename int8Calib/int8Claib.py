...
#
# # 设置源目录和目标目录
# src_images = r'E:\vtuav_1.0_down\images\train'
# src_image = r'E:\vtuav_1.0_down\image\train'
# src_labels = r'E:\vtuav_1.0_down\labels\train'
...
# dest_base = r'E:\vtuav_1.0_down\claib'
...
# model = YOLO('/home/omnisky/hzp/TBD-MFDet/yaml/ADDyolov8.yaml')
# # # Train the mod
# results = model.train(data=r'/home/omnisky/hzp/TBD-MFDet/data/vtuav_1.0_down_claib.yaml',batch=16,epochs=1)
#
# # 根据校准集生成int8 engine
#     model = YOLO("/home/omnisky/hzp/TBD-MFDet/weights/vtuav/GPT_79.6.pt")
#     model.export(format='onnx', opset=12, dynamic=False, simplify=False,device=[0,1,2,3])
#     model.export(format='engine', opset=12, int8=True, dynamic=True, batch=8, data=r'/home/omnisky/hzp/TBD-MFDet/data/vtuav_1.0_down_claib.yaml')
#     model.export(format='engine', opset=12, int8=True, dynamic=True, batch=8)
#   model.export(format='engine', opset=12, half=True, dynamic=True, simplify=False, device=[0,1,2,3])
#
#
# # 测试
model = YOLO('/home/omnisky/hzp/TBD-MFDet/weights/vtsar/vtsar_gpt.pt')
metrics = model.val(data='/home/omnisky/hzp/TBD-MFDet/data/vtsar.yaml',split='val',imgsz=640,batch=8,conf=0.01,iou=0.45)
# metrics = model.val(data='/home/omnisky/hzp/TBD-MFDet/data/VTUAV_down.yaml',split='val',imgsz=640,batch=16,conf=0.25,iou=0.5)